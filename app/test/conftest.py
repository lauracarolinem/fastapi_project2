...
def products_on_db(db_session):
    ...
    products = [
        ...
        ProductModel(name='Moletom Mike', slug='moletom', price=90, stock=9, category_id=category.id),
        ProductModel(name='Short', slug='short', price=80, stock=8, category_id=category.id),
        ProductModel(name='Camiseta', slug='camiseta-mike', price=70, stock=7, category_id=category.id)
    ]
